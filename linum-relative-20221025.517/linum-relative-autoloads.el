;;; linum-relative-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Toggle between linum-relative and linum." t)
(autoload 'linum-relative-mode "linum-relative" "\
Display relative line numbers for current buffer.

This is a minor mode.  If called interactively, toggle the
`Linum-Relative mode' mode.  If the prefix argument is positive, enable
...
evaluate the variable `linum-relative-mode'.
...
This is a minor mode.  If called interactively, toggle the
`Helm-Linum-Relative mode' mode.  If the prefix argument is positive,
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `helm-linum-relative-mode'.
